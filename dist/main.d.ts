...
import { defaultHandlers } from './config';
...
export { defaultParse as parse, defaultHandlers, allHandlers as handlers, allResolvers as resolver, allImporters as importers, utils, };
